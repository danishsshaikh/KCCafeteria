...
<body>
    <section>
        <div id="main">
            ...
            <a href="Register.php" id="mainnn_nnname">Log Out</a>
    ...
    <div class="container">
        ...
        <div class="col-md-4">
            <form method="post" action="index.php?action=add&id=<?php echo $row["id"]; ?>">
                <div style="border:3px solid #5cb85c; background-color:whitesmoke; border-radius:2px; padding:16px;" align="center">
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    <td colspan="5" align="right"> <input type="Submit" value="Submit" class="btn btn-primary">
                    </td>
                </tr>
